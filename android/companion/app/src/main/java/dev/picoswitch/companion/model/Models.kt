...
typealias PeerInfo = dev.picoswitch.management.PeerInfo
typealias PeerRole = dev.picoswitch.management.PeerRole
typealias PeerTransport = dev.picoswitch.management.PeerTransport
typealias PeerInventory = dev.picoswitch.management.PeerInventory
typealias PeerForgetResult = dev.picoswitch.management.PeerForgetResult
typealias PairingState = dev.picoswitch.management.PairingState
typealias PairingReason = dev.picoswitch.management.PairingReason
typealias PairingStatus = dev.picoswitch.management.PairingStatus
typealias PeerForgetOutcome = dev.picoswitch.management.PeerForgetOutcome
