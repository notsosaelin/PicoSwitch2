...
object BridgeHidDescriptor {
    val bytes = byteArrayOf(
        ...
        // buttons 1..15 (15 = C / GameChat) + 1 pad bit, still two bytes wide
        0x05, 0x09, 0x19, 0x01, 0x29, 0x0F, 0x15, 0x00, 0x25, 0x01, 0x75, 0x01,
        0x95.toByte(), 0x0F, 0x81.toByte(), 0x02, 0x75, 0x01, 0x95.toByte(), 0x01, 0x81.toByte(), 0x03,
        // v1 hat
