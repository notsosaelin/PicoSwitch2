...
class ControllerReportEncoderTest {
    ...
    @Test fun `descriptor stays byte exact`() {
        ...
        val golden = """
            ...
            15 00 26 FF 00 75 08 95 06 81 02 05 09 19 01 29 0F 15 00 25
            01 75 01 95 0F 81 02 75 01 95 01 81 03 05 01 09 39 15 00 25
    ...
    @Test fun `extreme simultaneous report keeps every field bounded`() {
        ...
        assertEquals(ControllerReportEncoder.PAYLOAD_SIZE_V2, report.size)
        assertArrayEquals(
            // 0x7F: fifteen buttons now, so bit 14 (C / GameChat) is live.
            byteArrayOf(0, 255.toByte(), 0, 255.toByte(), 0, 255.toByte(), 255.toByte(), 0x7F, 1),
            report.copyOfRange(0, ControllerReportEncoder.PAYLOAD_SIZE),
        )
    }
