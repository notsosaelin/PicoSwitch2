...
8. On **Input**, choose the built-in controller, leave layout on **Auto**, and tap **Use this
...
10. If anything differs, open Settings -> Developer and **Share diagnostics**. Send the text file
