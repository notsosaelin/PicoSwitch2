...
// Persist which POSITION a layout realizes at power-up, and realize it. The
// ONLY profile selection worth a flash write: Apply and a profile-switch key are
// both runtime-only.
...
// The POSITION this layout is realizing RIGHT NOW, which a switch key changes
