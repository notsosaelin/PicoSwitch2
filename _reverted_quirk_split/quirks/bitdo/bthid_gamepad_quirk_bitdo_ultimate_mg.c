...
// Elite Series 2 quirk already uses -- these already have a working default remap
// (NS2_DEFAULT_MAP routes them to GL/GR in Pro2 mode, ns2_seam.c's joycon2_active
// reinterpretation routes them to SL/SR in Joy-Con2 mode), so no new remap-table work is
// needed for them to reach an output personality.
