...
> Archived 2026-07-25. This design predates the validated UART/BLE bridge and incorrectly treats
> on-console USB NFC as architecturally impossible. Use
> [`../switch2/nfc-implementation.md`](../switch2/nfc-implementation.md) for current planning.
...
> evidence in
> [`nfc-protocol-inventory-through-2026-07-12.archived.md`](nfc-protocol-inventory-through-2026-07-12.archived.md)
